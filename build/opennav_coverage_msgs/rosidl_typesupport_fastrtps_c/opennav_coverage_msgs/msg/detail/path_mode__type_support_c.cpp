  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const opennav_coverage_msgs__msg__PathMode * ros_message = static_cast<const opennav_coverage_msgs__msg__PathMode *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_opennav_coverage_msgs__msg__PathMode(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  opennav_coverage_msgs__msg__PathMode * ros_message = static_cast<opennav_coverage_msgs__msg__PathMode *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_opennav_coverage_msgs__msg__PathMode(cdr, ros_message);
}
