...
#ifndef OPENNAV_COVERAGE_MSGS__MSG__PATH_COMPONENTS_H_
#define OPENNAV_COVERAGE_MSGS__MSG__PATH_COMPONENTS_H_
...
#endif  // OPENNAV_COVERAGE_MSGS__MSG__PATH_COMPONENTS_H_
