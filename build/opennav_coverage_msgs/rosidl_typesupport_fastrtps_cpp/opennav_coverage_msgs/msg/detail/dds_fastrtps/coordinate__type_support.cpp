...
#include "opennav_coverage_msgs/msg/detail/coordinate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const opennav_coverage_msgs::msg::Coordinate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  opennav_coverage_msgs::msg::Coordinate & ros_message)
{
  // Member: axis1
  cdr >> ros_message.axis1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = opennav_coverage_msgs::msg::Coordinate;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const opennav_coverage_msgs::msg::Coordinate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<opennav_coverage_msgs::msg::Coordinate *>(
    untyped_ros_message);
...
{
  return &opennav_coverage_msgs::msg::typesupport_fastrtps_cpp::_Coordinate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opennav_coverage_msgs, msg, Coordinate)() {
  return &opennav_coverage_msgs::msg::typesupport_fastrtps_cpp::_Coordinate__handle;
}
