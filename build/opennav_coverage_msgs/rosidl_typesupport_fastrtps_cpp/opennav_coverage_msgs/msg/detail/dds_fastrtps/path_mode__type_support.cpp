...
#include "opennav_coverage_msgs/msg/detail/path_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const opennav_coverage_msgs::msg::PathMode & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.continuity_mode;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  opennav_coverage_msgs::msg::PathMode & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = opennav_coverage_msgs::msg::PathMode;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_opennav_coverage_msgs
max_serialized_size_key_PathMode(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const opennav_coverage_msgs::msg::PathMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<opennav_coverage_msgs::msg::PathMode *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PathMode__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const opennav_coverage_msgs::msg::PathMode *>(
...
static size_t _PathMode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PathMode(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PathMode__callbacks = {
...
static rosidl_message_type_support_t _PathMode__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PathMode__callbacks,
...
{
  return &opennav_coverage_msgs::msg::typesupport_fastrtps_cpp::_PathMode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opennav_coverage_msgs, msg, PathMode)() {
  return &opennav_coverage_msgs::msg::typesupport_fastrtps_cpp::_PathMode__handle;
}
