...
static const _Coordinate_type_support_symbol_names_t _Coordinate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opennav_coverage_msgs, msg, Coordinate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, opennav_coverage_msgs, msg, Coordinate)),
  }
};
...
{
  return &::opennav_coverage_msgs::msg::rosidl_typesupport_cpp::Coordinate_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, opennav_coverage_msgs, msg, Coordinate)() {
  return get_message_type_support_handle<opennav_coverage_msgs::msg::Coordinate>();
}
