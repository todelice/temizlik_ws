...
static const _SwathMode_type_support_symbol_names_t _SwathMode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opennav_coverage_msgs, msg, SwathMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, opennav_coverage_msgs, msg, SwathMode)),
  }
};
...
{
  return &::opennav_coverage_msgs::msg::rosidl_typesupport_cpp::SwathMode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, opennav_coverage_msgs, msg, SwathMode)() {
  return get_message_type_support_handle<opennav_coverage_msgs::msg::SwathMode>();
}
