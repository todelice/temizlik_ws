...
class Coordinate(metaclass=Metaclass_Coordinate):
    ...
    def __init__(self, **kwargs):
        ...
        self.axis1 = kwargs.get('axis1', float())
        self.axis2 = kwargs.get('axis2', float())
    ...
    def axis1(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'axis1' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'axis1' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._axis1 = value
    ...
    def axis2(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'axis2' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'axis2' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._axis2 = value
