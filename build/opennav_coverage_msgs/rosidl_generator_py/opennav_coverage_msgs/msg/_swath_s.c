...
bool opennav_coverage_msgs__msg__swath__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("opennav_coverage_msgs.msg._swath.Swath", full_classname_dest, 38) == 0);
  }
  opennav_coverage_msgs__msg__Swath * ros_message = _ros_message;
  {  // start
    PyObject * field = PyObject_GetAttrString(_pymsg, "start");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__point32__convert_from_py(field, &ros_message->start)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // end
    ...
    if (!geometry_msgs__msg__point32__convert_from_py(field, &ros_message->end)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of Swath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("opennav_coverage_msgs.msg._swath");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Swath");
  ...
  {  // start
    PyObject * field = NULL;
    field = geometry_msgs__msg__point32__convert_to_py(&ros_message->start);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // end
    PyObject * field = NULL;
    field = geometry_msgs__msg__point32__convert_to_py(&ros_message->end);
    if (!field) {
      return NULL;
    }
    {
