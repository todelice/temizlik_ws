...
class Coordinates(metaclass=Metaclass_Coordinates):
    ...
    _fields_and_field_types = {
        'coordinates': 'sequence<opennav_coverage_msgs/Coordinate>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['opennav_coverage_msgs', 'msg'], 'Coordinate')),  # noqa: E501
    )
